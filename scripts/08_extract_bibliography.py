...
# OCR extraction still merges some early Bibliography B rows across multiple
# real works. Keep the generated file from emitting those corrupted records and
# supply source-backed replacements in keightley_manual.bib instead.
MANUAL_OVERRIDE_KEYS = {
    ...
    "Chti1965Yen",
    "Chti1965aKuo",
    "Chti1971Multivariate",
    "Chti1973Calibration",
    "Cooper1936Scapulimancy",
    "Creel1935Dragon",
    "Creel1938Studies",
    "Damon1936Mammalian",
    "Deydier1974BALD",
    "Eberhard1937Witchcraft",
    "Gardner1934The",
    "Gardner1958Chinese",
    "Gardner1971Archaeological",
    "Hayashi1968BIE",
    "Hayashi1971Chosa",
    "Hiroshima1956Ping",
    "Hiroshima1973The",
    ...
    "Jung1973Kao",
    "Jung1975Hsia",
    "Karlbeck1957Treasure",
    "Karlgren1937Grammata",
    "Karlgren1963Loan",
    "Kato1970Kanji",
    "Kato1939Shuo",
    "Keightley1969Public",
    "Keightley1969aBook",
    "Keightley1972New",
    "Keightley1973Religion",
    "Keightley1973aShang",
    "Keightley1975The",
    "Keightley1975aThe",
    "Keightley1975Legitimation",
    "Kigoshi1966Secular",
    "Kluckhohn1970The",
    "Knoblock1964The",
    "Knoblock1968Work",
    ...
    "Shih1959Hsiao",
    "Shih1976Teishin",
    "Shirakawa1948Teishin",
    "Shirakawa1954EAR",
    "Tang1965CFG",
    "Tang1973Kuan",
    "Tang1976Work",
    "Tang1905Synchronismes",
    "Teng1971Annotated",
    "Thai1963Curiosit",
    "Thai1969Chinese",
    "Thorp1936Geography",
    ...
    "Oracle1976bThree",
    "Oracle1977Index",
    "Middleton1960Lugbara",
    "Miyazaki1970Chiigoku",
    "Montell1934Clemmys",
    "Van1958Chin",
    "Van1967Yin",
    "LPR1907Sei",
    ...
    "Basso1973Western",
    "Bawden1958Practice",
    "Bawden1967Divination",
    "BenedettiPichler1932The",
    "Bloch1953The",
    "Bloch1889Catalogue",
    "Britton1936Sinological",
    "Britton1937Oracle",
    "Britton1940Fifty",
    "Britton1968Divination",
    "Japan1972The",
    "Japan1972Work",
    "Studies1963Dragon",
    "Studies1970The",
...
def emit_bib(entries: list[dict]) -> str:
    ...
    for e in entries:
        ...
        if key in MANUAL_OVERRIDE_KEYS:
            continue
        ...
        lines = [
            ...
            author_line,
            f"  year        = {{{e['year']}}},",
            f"  title       = {{{_bibsafe(chosen_title)}}}",
        ]
        if titleaddon:
            lines[-1] += ","
            lines.append(f"  titleaddon  = {{{_bibsafe(titleaddon)}}}")
        if e.get("author_cjk"):
            lines[-1] += ","
            lines.append(f"  nameaddon   = {{{_bibsafe(e['author_cjk'])}}}")
        # Keep the live BibLaTeX file syntactically safe; detailed OCR proofing
        # remains in the extracted TSV / QA artifacts instead of printable note dumps.
        lines[-1] += ","
        lines.append(
            "  annotation   = {CHECK: bibliography extraction artifacts retained "
            "in data/bibliography_raw.tsv and build/qa/bibliography_extraction.md.}"
        )
        lines.append("}\n")
        out.extend(lines)
    return "\n".join(out) + "\n"
